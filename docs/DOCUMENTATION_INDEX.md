# FRW Documentation Index

Complete guide to all documentation in the FRW project.

---

## Getting Started

**New to FRW? Start here:**

1. [../MANIFESTO.md](../MANIFESTO.md) - **Why FRW exists** - Our vision and principles
2. [../README.md](../README.md) - Project overview and quick introduction
3. [../QUICK_START.md](../QUICK_START.md) - Get running in 5 minutes
4. [INSTALLATION_GUIDE.md](INSTALLATION_GUIDE.md) - Detailed installation instructions
5. [USER_GUIDE.md](USER_GUIDE.md) - How to use the browser and CLI
...
- **[../QUICK_START.md](../QUICK_START.md)** - Fast setup for new users
- **[INSTALLATION_GUIDE.md](INSTALLATION_GUIDE.md)** - Complete installation process
- **[USER_GUIDE.md](USER_GUIDE.md)** - Browser usage, CLI commands, navigation
- **[IPFS_SETUP.md](IPFS_SETUP.md)** - Configure IPFS for FRW

### Workflows

- Publishing content with CLI
- Browsing frw:// URLs
- Managing keys and identity
...
- **[SPECIFICATION.md](SPECIFICATION.md)** - FRW Protocol v1.0 specification
- **[BROWSER_PLAN.md](BROWSER_PLAN.md)** - Browser architecture and implementation
- **[PROJECT_STRUCTURE.md](PROJECT_STRUCTURE.md)** - Monorepo file organization

### Security

- **[SECURITY.md](SECURITY.md)** - Security model, threat analysis, cryptography
...
- **[NAMING_SYSTEM.md](NAMING_SYSTEM.md)** - Human-readable name resolution
...
- **[../CONTRIBUTING.md](../CONTRIBUTING.md)** - How to contribute to FRW
- **[DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md)** - API reference and development guide
- **[MIGRATION_GUIDE.md](MIGRATION_GUIDE.md)** - Monorepo migration instructions
...
### Installation & Setup
- [INSTALLATION_GUIDE.md](INSTALLATION_GUIDE.md) - Full installation
- [IPFS_SETUP.md](IPFS_SETUP.md) - IPFS configuration
- [../QUICK_START.md](../QUICK_START.md) - Fast setup

### Usage
- [USER_GUIDE.md](USER_GUIDE.md) - Browser and CLI usage
- [../QUICK_START.md](../QUICK_START.md) - Basic workflows

### Development
- [../CONTRIBUTING.md](../CONTRIBUTING.md) - Contribution guidelines
- [DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md) - API reference
- [MIGRATION_GUIDE.md](MIGRATION_GUIDE.md) - Monorepo setup

### Architecture
- [ARCHITECTURE.md](ARCHITECTURE.md) - System design
- [SPECIFICATION.md](SPECIFICATION.md) - Protocol spec
- [BROWSER_PLAN.md](BROWSER_PLAN.md) - Browser implementation
- [PROJECT_STRUCTURE.md](PROJECT_STRUCTURE.md) - File organization

### Security
- [SECURITY.md](SECURITY.md) - Security model
- [SPECIFICATION.md](SPECIFICATION.md) - Signature verification
...
- **History** - When implemented, update USER_GUIDE.md
...
- **Read protocol spec** → [SPECIFICATION.md](SPECIFICATION.md)
...
- Existing files are significantly updated
- Files are removed or consolidated
- Major features are added

**Last updated:** November 9, 2025  
**Documentation version:** Aligned with v0.2.0-alpha.1
